...
set_property PACKAGE_PIN W4 [get_ports {lightctl[0]}]
set_property PACKAGE_PIN V4 [get_ports {lightctl[1]}]
set_property PACKAGE_PIN U4 [get_ports {lightctl[2]}]
set_property PACKAGE_PIN U2 [get_ports {lightctl[3]}]
